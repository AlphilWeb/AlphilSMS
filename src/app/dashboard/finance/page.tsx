...
export default async function BursarDashboard() {
  try {
    ...
    // Trends from statistics (percent deltas)
    // const revenueChange = data.statistics?.revenueChange ?? 0;
    const netRevenueChange = data.statistics?.netRevenueChange ?? 0;

const formattedPayments = data.recentPayments.map(payment => ({
  ...payment,
  id: String(payment.id) // Convert the number ID to a string
}));
        ...
        <main className="md:pl-64 pt-2 h-[calc(100vh-4rem)] overflow-y-auto bg-emerald-800 text-white">
          <div className="p-6 space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-6">
                ...
                <Card
                  ...
                  link="/dashboard/bursar/salaries"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                {/* Repurposed card: Outstanding Amount instead of nonexistent feeCollections */}
                <Card
                  title="Outstanding Amount"
                  value={`$${data.financialSummary.totalOutstanding.toLocaleString()}`}
                  icon={<FiCreditCard className="w-5 h-5" />}
                  
                  link="/dashboard/bursar/invoices"
                  linkText="View Invoices"
                />

                {/* Repurposed card: Active Invoices instead of nonexistent reportsGenerated */}
                <Card
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FinancialSummaryCard
                ...
                // treat salaries as expenses for the summary widget
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <a
                    href="/dashboard/bursar/analytics"
