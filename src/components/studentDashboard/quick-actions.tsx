    ...
    <div className="bg-white rounded-lg shadow p-6 mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        >
          ...
          <span className="text-pink-500 text-sm text-center">Check Grades</span>
        </Link>
        <Link 
        ...
        >
          ...
          <span className="text-pink-500 text-sm text-center">Make Payment</span>
        </Link>
        <Link 
        ...
        >
          ...
          <span className="text-pink-500 text-sm text-center">Download Transcript</span>
        </Link>
      </div>
    </div>
  );
