    ...
    <div className="bg-white rounded-lg shadow p-6 mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Link 
          ...
          className="text-pink-600 flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-emerald-50 transition-colors"
        >
        ...
        >
          ...
          <span className="text-pink-600 text-sm text-center">Check Grades</span>
        </Link>
        <Link 
        ...
        >
          ...
          <span className="text-pink-600 text-sm text-center">View Timetable</span>
        </Link>
        <Link 
        ...
        >
          ...
          <span className="text-pink-600 text-sm text-center">Make Payment</span>
        </Link>
        <Link 
        ...
        >
          ...
          <span className="text-pink-600 text-sm text-center">Download Transcript</span>
        </Link>
      </div>
    </div>
  );
